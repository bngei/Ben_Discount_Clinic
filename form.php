...
<?php
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        if (mysqli_query($conn, $sql_address)) {
            ...
            $sql_patient = "INSERT INTO patient (user_id, primary_doctor_id, address_id, first_name, middle_initial, last_name, gender, phone_number, DOB, total_owe, deleted) 
            VALUES ($user_id_fk, $primary_doctor_id, $address_id, '$firstname', '$middleInitial', '$last_name', '$gender', '$phone', '$dob', 0, 0)";
